...
No definitions from the local scope will be available in the loaded
file.
...
=head2 Including data from external files

An external file containing data can be C<@include>d in any current
data structure. Only the data generated by the included file will be
available. None of the environment changes of the included file will
be imported into the current scope.

You will need to pass C<include_paths> to L</new> to be able to
include files.
